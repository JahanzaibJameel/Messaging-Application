 ...
 */
export const getDirectionalStyle = (start?: number, end?: number, top?: number, bottom?: number) => {
  const isRTL = i18n.dir() === 'rtl';
 ...
 */
export const getDirectionalPadding = (start?: number, end?: number, top?: number, bottom?: number) => {
  const isRTL = i18n.dir() === 'rtl';
