...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 15, textAlign: "center", lineHeight: 22, paddingHorizontal: Spacing.xl },
  ...
  countryCode: { fontSize: 16, fontWeight: "500" },
  phoneInput: { flex: 1, paddingHorizontal: Spacing.lg, fontSize: 16, height: "100%" },
