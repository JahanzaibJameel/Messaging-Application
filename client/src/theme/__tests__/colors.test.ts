...
describe("Theme Colors", () => {
  describe("Light Theme", () => {
    ...
    it("should have valid text color values", () => {
      ...
      expect(colors.light.textTertiary).toBe("#B0B3B8");
    });
  ...
  describe("Dark Theme", () => {
    ...
    it("should have valid status color values", () => {
      expect(darkTheme.success).toBe("#25D366");
      expect(darkTheme.warning).toBe("#FFA500");
      expect(darkTheme.error).toBe("#FF3B30");
      expect(darkTheme.info).toBe("#007AFF");
    });
